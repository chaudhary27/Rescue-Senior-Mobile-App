...
4. Run **ionic serve** and navigate to localhost in your browser
5. Run **ionic serve -l** to see the app in mobile platform
6. Run the app locally by adding mobile platform plugins
